...
GOOSARCHES = linux/amd64 linux/arm64 windows/amd64
...
protoc: ## Generate protobuf files
	protoc --go_out=. --go-grpc_out=. --go_opt=paths=source_relative --go-grpc_opt=paths=source_relative pkg/sinks/plugin/proto/metrics.proto
