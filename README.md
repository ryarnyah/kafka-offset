...
- **linux** [amd64](https://github.com/ryarnyah/kafka-offset/releases/download/0.5.1/kafka-offset-linux-amd64) [386](https://github.com/ryarnyah/kafka-offset/releases/download/0.5.1/kafka-offset-linux-386) [arm](https://github.com/ryarnyah/kafka-offset/releases/download/0.5.1/kafka-offset-linux-arm) [arm64](https://github.com/ryarnyah/kafka-offset/releases/download/0.5.1/kafka-offset-linux-arm64)
- **windows** [amd64](https://github.com/ryarnyah/kafka-offset/releases/download/0.5.1/kafka-offset-windows-amd64) [386](https://github.com/ryarnyah/kafka-offset/releases/download/0.5.1/kafka-offset-windows-386)

```bash
sudo curl -L https://github.com/ryarnyah/kafka-offset/releases/download/0.5.1/kafka-offset-linux-amd64 -o /usr/local/bin/kafka-offset && sudo chmod +x /usr/local/bin/kafka-offset
```
...
#### Running with Docker
```bash
docker run ryarnyah/kafka-offset-linux-amd64:0.5.1 <option>
```
...
##### Example
```bash
docker run ryarnyah/kafka-offset-linux-amd64:0.5.1 -sink log -source-brokers localhost:9092
```
...
##### Example
```bash
docker run ryarnyah/kafka-offset-linux-amd64:0.5.1 -sink kafka -source-brokers localhost:9092 -kafka-sink-brokers localhost:9092 -kafka-sink-topic metrics
```
...
##### Example
```bash
docker run ryarnyah/kafka-offset-linux-amd64:0.5.1 -sink elasticsearch -source-brokers localhost:9092 -elasticsearch-sink-url localhost:9200 -elasticsearch-sink-index metrics
```
...
##### Example
```bash
docker run ryarnyah/kafka-offset-linux-amd64:0.5.1 -sink influxdb -source-brokers localhost:9092 -influxdb-addr http://localhost:8086
```
