...
#### Running with Docker
```bash
docker run ryarnyah/kafka-offset-linux-amd64:0.8.2 <option>
```
...
##### Example
```bash
docker run ryarnyah/kafka-offset-linux-amd64:0.8.2 -sink log -source-brokers localhost:9092
```
...
##### Example
```bash
docker run ryarnyah/kafka-offset-linux-amd64:0.8.2 -sink kafka -source-brokers localhost:9092 -kafka-sink-brokers localhost:9092 -kafka-sink-topic metrics
```
...
##### Example
```bash
docker run ryarnyah/kafka-offset-linux-amd64:0.8.2 -sink elasticsearch -source-brokers localhost:9092 -elasticsearch-sink-url localhost:9200 -elasticsearch-sink-index metrics
```
...
##### Example
```bash
docker run ryarnyah/kafka-offset-linux-amd64:0.8.2 -sink influxdb -source-brokers localhost:9092 -influxdb-addr http://localhost:8086
```
...
To run it:
```bash
docker run ryarnyah/kafka-offset-linux-amd64:0.8.2 -sink plugin -source-brokers localhost:9092 -plugin-cmd "/plugins/my-plugin arg1 arg2"
```
