...
func (x *KafkaMeter) GetTimestamp() *timestamp.Timestamp {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
func (x *KafkaGauge) GetTimestamp() *timestamp.Timestamp {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
type WriteKafkaMetricsRequest struct {
	...
	Metrics []*any.Any `protobuf:"bytes,1,rep,name=metrics,proto3" json:"metrics,omitempty"`
}
...
func (x *WriteKafkaMetricsRequest) GetMetrics() []*any.Any {
	if x != nil {
		return x.Metrics
	}
	return nil
...
var file_pkg_sinks_plugin_proto_metrics_proto_goTypes = []interface{}{
...
func file_pkg_sinks_plugin_proto_metrics_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pkg_sinks_plugin_proto_metrics_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_sinks_plugin_proto_metrics_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_sinks_plugin_proto_metrics_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_sinks_plugin_proto_metrics_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Empty); i {
			case 0:
				return &v.state
			case 1:
